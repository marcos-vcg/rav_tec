...
public class LocacaoTeste extends JInternalFrame {

	static final int xPosition = 30, yPosition = 30;
	private final Action salvar = new SwingAction();
	private final Action voltar = new SwingAction_1();

	public LocacaoTeste(ArrayList<Filme> cadFilme, ArrayList<Genero> cadGenero, ArrayList<Categoria> cadCategoria, ArrayList<Cliente> cadCliente) {
		...
		JLabel lblCopias = new JLabel("Cópias:");
