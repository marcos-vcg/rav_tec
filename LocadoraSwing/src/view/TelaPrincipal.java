...
//		String[] opcoes = generos.toArray(new String[0]);
	...
	public TelaPrincipal() {
		...
		String[] opcoes = {"Selecione", "Suspense", "Terror", "Ação"};
		...
		comboBoxGenero.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				// Repassa a opção escolhida através do case
			}
		});
...
// JOptionPane.showMessageDialog(null, "A mensagem", "O título da Aba", JOptionPane.WARNING_MESSAGE);	